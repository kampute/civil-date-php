[![Version](https://img.shields.io/github/v/release/kampute/civil-date-php?label=Version)](https://github.com/kampute/civil-date-php/releases)

# civil-date

Accurate Jalali, Gregorian, and Islamic date handling for PHP.
...
[MIT](https://github.com/kampute/civil-date/blob/main/LICENSE) © Kampute
